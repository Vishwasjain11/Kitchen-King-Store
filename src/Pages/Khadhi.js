...
import { Khadhisell } from '../assets/assets';
...
function Khadhi() {
  ...
  return (
    <div className="bg-gray-100 py-12">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-10 text-gray-800">
        Triply Cookware Collection
      </h1>
          ...
          {Khadhisell.map((item) => (
            ...
            >
              ...
              <div className="p-4 sm:p-6 flex flex-col justify-between h-[40%]">
                <h3 className="text-lg sm:text-xl font-semibold mb-2">{item.desc}</h3>
      ...
      <div className="flex items-center justify-center pt-8 sm:pt-10">
        <button
          className="bg-blue-500 text-white py-2 px-6 sm:px-8 rounded-lg text-lg sm:text-2xl hover:bg-blue-600 transition"
        >
          See More
        </button>
      </div>
